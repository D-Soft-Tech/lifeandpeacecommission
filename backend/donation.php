                ...
                <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
                    ...
                    <!-- Main Content Starts from Here -->
                        <div class="app-main">
                                ...
                                <div class="app-main__outer">
                                    <div class="app-main__inner">
                                        ...
                                        <?php 
                                            ...
                                            $start = ($page - 1) * $limit;
                                            $result = $conn->query("SELECT * FROM donation ORDER BY id DESC LIMIT $start, $limit");
                                            $donations = $result->fetchAll();

                                            $result1 = $conn->query("SELECT count(id) AS id FROM donation");
                                        ...
                                        ?>
                                            ...
                                            <?php include_once 'donationcontent.php'; ?>
                                        </div>
                                ...
                                <div class="modal fade bd-example-modal-lg mt-5" id="removeDonation" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-backdrop="false">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            <div class="position-relative">
                                                <p>
                                                    <h6 class="text-center">You are about to remove the donation from the database</h6>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" id="" onclick="removeDonation(this.id)" class="mr-5 btn-transition btn btn-outline-danger finalDelete" data-dismiss="modal">
                                                Yes, Proceed
                                            </button>
                                        </div>
                                    </div>
