                ...
                <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
                    ...
                    <!-- Main Content Starts from Here -->
                        <div class="app-main">
                                ...
                                <div class="app-main__outer">
                                    <div class="app-main__inner">
                                        ...
                                        ?>
                                            ...
                                            <?php include_once 'imagecontent.php'; ?>
                                        </div>
                                ...
                                <div class="modal fade bd-example-modal-lg mt-5" id="removeGalleryModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-backdrop="false">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                <div class="position-relative">
                                                    <p>
                                                        <h6 class="text-center">You are about to Delete this photo from your photo album</h6>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <button id="" name="" value="" onclick="removePhoto(this.id, this.name, this.value)" class="mr-5 btn-transition btn btn-outline-danger finalPhotoDelete" data-dismiss="modal">
                                                    Yes, Proceed
                                                </button>
                                            </div>
                                        </div>
                ...
                <script>
                    ...
                    $(document).ready(function (){
                        ...
                        $('.deleteGallery').click(function (){
                            ...
                            $('.finalPhotoDelete').attr("id", id);
                            $('.finalPhotoDelete').attr("name", name);
                            $('.finalPhotoDelete').attr("value", value);

                            $('#removeGalleryModal').modal('show');
                        });
                    });

                    function removePhoto(id, name, value)
                    {
                        XmlHttp
                        (
                            {
                                url: 'testing.php',
                                type: 'POST',
                                data: "removePhoto="+id+"=&name="+name+"&value="+value,
