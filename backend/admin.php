                    ...
                    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
                        ...
                        <!-- Main Content Starts from Here -->
                            <div class="app-main">
                                    ...
                                    <div class="app-main__outer">
                                        <div class="app-main__inner">
                                            ...
                                            <?php 
                                                ...
                                                $start = ($page - 1) * $limit;
                                                $result = $conn->query("SELECT * FROM admin WHERE permission = '0' ORDER BY admin_id DESC LIMIT $start, $limit");
                                                $admins = $result->fetchAll();

                                                $result1 = $conn->query("SELECT count(admin_id) AS id FROM admin");
                                    ...
                                    <div class="modal fade bd-example-modal-lg mt-5" id="removeAdminModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-backdrop="false">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                <div class="position-relative">
                                                    <p>
                                                        <h6 class="text-center">You are about to remove this person from your team of adminstrator</h6>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" id="" onclick="deleteAdmin(this.id)" class="mr-5 btn-transition btn btn-outline-danger finalAdminDelete" data-dismiss="modal">
                                                    Yes, Proceed
                                                </button>
                                            </div>
                                        </div>
