                                        ...
                                        <div class="app-main__inner">
                                            ...
                                            <div id="maincontent">
                                                ...
                                                <?php
                                                    ...
                                                    $start = ($page - 1) * $limit;
                                                    $result = $conn->query("SELECT id, title, link, ext, ext2 FROM message WHERE type = 'audio' && month = '$month' && year = '$year' ORDER BY id DESC LIMIT $start, $limit");
                                                    $audios = $result->fetchAll();

                                                    $result1 = $conn->query("SELECT count(id) AS id FROM message WHERE type = 'audio' && month = '$month' && year = '$year'");
                                                ...
                                                <?php include_once 'audiocontent.php'; ?>
                                            </div>
                                                <!-- Warning Modal before deleting a contact message -->
                                                <div class="modal fade bd-example-modal-lg mt-5" id="removeAudioModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-backdrop="false">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="position-relative">
                                                                <p>
                                                                    <h6 class="text-center">You are about to remove this Audio Message from Archive</h6>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" id="" name="" value="" onclick="removeAudio(this.id, this.name, this.value)" class="mr-5 btn-transition btn btn-outline-danger finalDelete" data-dismiss="modal">
                                                                Yes, Proceed
                                                            </button>
                                                        </div>
                                                    </div>
                    ...
                    <script>
                        ...
                        $(document).ready(function (){
                            ...
                            $('.removeAudio').click(function (){
                                ...
                                var audio_name = $(this).attr("name");
                                var audio_value = $(this).attr("value");

                                $('.finalDelete').attr("id", audio_id);
                                $('.finalDelete').attr("name", audio_name);
                                $('.finalDelete').attr("value", audio_value);

                                $('#removeAudioModal').modal('show');
                            });
                        });

                        function removeAudio(id, name, value){
                            XmlHttp
                            (
                                {
                                    url: 'testing.php',
                                    type: 'POST',
                                    data: "removeAudio="+id+"&audio_name="+name+"&value="+value,
