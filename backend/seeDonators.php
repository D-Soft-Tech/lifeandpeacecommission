                                ...
                                <div class="app-main__outer">
                                    <div class="app-main__inner">
                                        ...
                                        <?php
                                            ...
                                            $donators = $result->fetchAll();
                                                  
                                            
                                            $sql5 = "SELECT title FROM donation WHERE id = :id5";

                                            $result_id = $conn->prepare($sql5);
                                            $result_id->execute([':id5' => $id]);
                                            $donation_name = $result_id->fetch();
                                            
                                            $result1 = $conn->prepare("SELECT count(id) AS id FROM users, transactions WHERE transactions.purpose = 'donation' && transactions.purpose_id = :id1 && users.user_id = transactions.user_id");
                                            $result1->execute([':id1' => $id]);
                                        ...
                                        ?>
                                            ...
                                            <?php include_once 'seeDonatorsContent.php'; ?>
                                        </div>
