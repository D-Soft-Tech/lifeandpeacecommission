        ...
        ?>
            ...
            <!doctype html>
                ...
                <body>
                                    ...
                                    <div class="app-main__outer">
                                        <div class="app-main__inner">
                                            ...
                                            <?php 
                                                ...
                                                $start = ($page - 1) * $limit;
                                                $result = $conn->query("SELECT full_name, email, phone, contacts.* FROM users, contacts 
                                                WHERE users.user_id = contacts.user_id && contacts.status = 'pending' 
                                                ORDER BY contact_id DESC LIMIT $start, $limit");
                                                $pendingContacts = $result->fetchAll();

                                                $result1 = $conn->query("SELECT count(contact_id) AS id FROM contacts WHERE contacts.status = 'pending'");
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                        ...
                                                        <?php
                                                            ...
                                                            {
                                                                $result =   '<div class="col-sm-12 alert alert-danger alert-dismissable flash-msg">
                                                                                <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                                                                                <h6><i class="icon fa pe-7s-attention"></i> Please fill out everything! All fields are required</h6>
                                                                            </div>';
                                                                            result($result);
                                                            } 
                                                            else 
                                                        ...
                                                        ?>
                                                <?php include_once 'contactcontent.php'; ?>
                                            </div>
                    ...
                    <!-- INSERT INTO `contacts` (`contact_id`, `user_id`, `contact_subject`, `date_added`, `details`, `status`) 
                    VALUES ('6', '6', 'I am grateful sir', '31th of july, 2020', 
                    'I just want to thank God for today\'s message. I was really blessed', 'pending'); -->
                    <!-- Ajax call to dynamically pollute the main content div depending on which button of the sidebar that is clicked -->
                    </body>
                </html>
