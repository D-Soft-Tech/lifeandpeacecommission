                                    ...
                                    <div class="app-main__outer">
                                        <div class="app-main__inner">
                                            ...
                                            <?php 
                                                    ...
                                                    WHERE users.user_id = contacts.user_id && contacts.status = 'read' 
                                                    ORDER BY contact_id DESC LIMIT $start, $limit");
                                                    $readContacts = $result->fetchAll();

                                                    $result1 = $conn->query("SELECT count(contact_id) AS id FROM contacts WHERE contacts.status = 'read'");
                                            ...
                                            ?>
                                                ...
                                                <?php include_once 'readContactContent.php'; ?>
                                            </div>
