                                    ...
                                    <div class="app-main__outer">
                                        <div class="app-main__inner">
                                            ...
                                            <?php 
                                                ...
                                                WHERE users.user_id = testimonies.user_id && testimonies.status = 'pending' 
                                                ORDER BY id DESC LIMIT $start, $limit");
                                                $pendingTestimonies = $result->fetchAll();

                                                $result1 = $conn->query("SELECT count(id) AS id FROM testimonies WHERE testimonies.status = 'pending'");
                                            ...
                                            ?>
                                                ...
                                                <?php include_once 'testimoniescontent.php'; ?>
                                            </div>
