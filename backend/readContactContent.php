    ...
    <div class="col-xs-12 col-md-8">
        <div class="card mb-3 widget-content bg-premium-dark">
            <div class="widget-content-wrapper text-white">
                ...
                <div class="mx-auto">
                    <div class="">
                        <a href="contact.php" class="btn btn-transition btn btn-sm btn-outline-info" aria-label="Next">
                ...
                <div class="widget-content-right">
                    <div class="">
                        <span class="font-weight-bold">
                            Already Read Messages in archive
...
<div class="ml-5">
    <nav aria-label="Page navigation">
        <ul class="pagination">
        <li>
            <a href="readContact.php?pages=<?= $Previous; ?>&page=<?= $page; ?>" 
        ...
        <?php 
            ...
            {
            ?>
            <li><a href="readContact.php?page=<?= $i; ?>&pages=<?= $pages; ?>" class="btn btn-transition btn btn-sm btn-outline-primary"><?= $i; ?></a></li>
            <?php 
            }
            ?>
        <li>
            <a href="readContact.php?pages=<?= $Next; ?>&page=<?= $page; ?>"
...
<?php foreach($readContacts as $readContacts) :  ?>
    <div class="main-card mb-3 card" id="<?= $readContacts['user_id']; ?>">
        <div class="card-header"><?= $readContacts['contact_subject']; ?></div>
        <div class="card-body">
            <p><span class="card-title"><?= $readContacts['full_name']; ?> &nbsp;</span>
                <span>
                <?= '0'. $readContacts['phone']. " ". $readContacts['email']; ?>
                </span>
            </p>
            <?= $readContacts['details']; ?> 
        </div>
        <div class="card-footer">
            <button id="<?= $readContacts['user_id']; ?>" class="mb-2 mr-5 btn-transition btn btn-outline-danger deleteMessage">
                Delete
            </button>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    setInterval("inbox('readContacts', 'sup')", 500);
