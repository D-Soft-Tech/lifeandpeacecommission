                    ...
                    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
                        ...
                        <!-- Main Content Starts from Here -->
                            <div class="app-main">
                                    ...
                                    <div class="app-main__outer">
                                        <div class="app-main__inner">
                                            ...
                                            <?php 
                                                ...
                                                if(isset($_POST['submitDeleteUser']) && !empty($_POST['submitDeleteUser']))
                                                {
                                                    $id = $_POST['submitDeleteUser'];
                                                    // $is_int = is_int($id) ? "true" : "false";  ASSIGNMENT:-  FIND HOW TO CHECK IF A VARIABLE IS AN INTEGER

                                                    $deletUserId = $_POST['submitDeleteUser'];

                                                    if(isset($deletUserId) && !empty($deletUserId))
                                                    {
                                                        $sql = "
                                                                    DELETE FROM users WHERE user_id = '$deletUserId'
                                                                ";
                                                        ...
                                                        if($checks === true OR $count>0)
                                                        {
                                                            $alertMsg =     '<div class="col-sm-12 alert alert-success alert-dismissable">'.
                                                                                ...
                                                                                '<h6><i class="icon fa pe-7s-check"></i> Successfully remove</h6>'.
                                                                            '</div>';
                                                        }
                                                        else
                                                        {
                                                            $alertMsg =  '<div class="col-sm-12 alert alert-danger alert-dismissable">'.
                                                                            '<button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>'.
                                                                            '<h6><i class="icon fa pe-7s-attention"></i> failed to remove user, please try again later</h6>'.
                                                                        '</div>';
                                                        }
                                                    }
                                                    else
                                                ...
                                                {   
                                                    ...
                                                    $start = ($page - 1) * $limit;
                                                    $sql = "
                                                                SELECT * FROM users WHERE username = '$input' OR user_id = '$input'
                                                                 OR full_name LIKE '%$input%' OR password LIKE '%$input'
                                                                  OR phone LIKE '%$input' OR address LIKE '%$input%' ORDER BY user_id LIMIT $start, $limit
                                                            ";
                                                    ...
                                                    $result1 = $conn->prepare("
                                                                                SELECT count(user_id) AS id FROM users WHERE username = '$input' OR user_id = '$input'
                                                                                OR full_name LIKE '%$input%' OR password LIKE '%$input'
                                                                                OR phone LIKE '%$input' OR address LIKE '%$input%'
                                                                            ");
                                                ...
                                                {   
                                                    ...
                                                    $start = ($page - 1) * $limit;
                                                    $sql = "
                                                                SELECT * FROM users ORDER BY user_id LIMIT $start, $limit
                                                            ";
                                                    ...
                                                    $result1 = $conn->prepare("
                                                                                SELECT count(user_id) AS id FROM users
                                                                            ");
                                            ...
                                            ?>
                                                ...
                                                <?php include_once 'userscontent.php'; ?>
                                            </div>
                                    ...
                                    <div class="modal fade bd-example-modal-lg mt-5" id="removeUserModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-backdrop="false">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                <div class="position-relative">
                                                    <p>
                                                        <h6 class="text-center">Are you sure you want to remove this user from database?</h6>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <form method="POST">
                                                    ...
                                                    <button name="submitDeleteUser" type="submit" value="" class="mr-5 btn-transition btn btn-outline-danger finalRemoveUser">
                                                        Yes, Proceed
                                                    </button>
                                                </form>
                                            </div>
                    ...
                    <script type="text/javascript">
                        ...
                        // $('.flash_msg').delay(250).fadeOut('slow');
                            ...
                            $('.removeUser').click(function (){
                                ...
                                $('.finalRemoveUser').attr("value", name);
