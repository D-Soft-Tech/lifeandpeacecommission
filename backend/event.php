                                    ...
                                    <div class="app-main__outer">
                                        <div class="app-main__inner">
                                            ...
                                            <?php 
                                                ...
                                                $start = ($page - 1) * $limit;
                                                $result = $conn->query("SELECT * FROM event ORDER BY event_id DESC LIMIT $start, $limit");
                                                $events = $result->fetchAll();

                                                $result1 = $conn->query("SELECT count(event_id) AS id FROM event");
                            ...
                            (
                                {
                                    url: 'testing.php',
                                    type: 'POST',
                                    data: "removeEvent="+id+"&name="+name+"&value="+value,
