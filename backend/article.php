            ...
            <!doctype html>
                ...
                <body>
                            ...
                            <div class="app-main">
                                    ...
                                    <div class="app-main__outer">
                                        <div class="app-main__inner">
                                            ...
                                            <?php 
                                                ...
                                                if(isset($_POST['postArticleNow']))
                                                {
                                                    $author = $_POST['author'];
                                                    $title = $_POST['title'];
                                                    $details = $_POST['details'];
                                                    $id = $_POST['postArticleNow'];

                                                    $current_date = date("l, F jS, Y");

                                                    function get_sql()
                                                    {
                                                        global $author, $title, $details, $id, $current_date;
                                                        if($_POST['edit']==="edit"){
                                                            return "UPDATE articles SET article_author = '$author', article_title = '$title', article_details = '$details' WHERE articles_id = '$id'";
                                                        }
                                                        elseif($_POST['edit']==="saveNew"){
                                                            return "INSERT INTO articles (article_author, article_title, article_details, date_added) VALUES('$author','$title','$details','$current_date')";
                                                        }
                                                    }

                                                    $sql = get_sql();

                                                    if($title !== '' && $details !== '' && $author !== '' && $sql !=='')
                                                    {
                                                        $check = $conn->prepare($sql);
                                                        $read = $check->execute();
                                                ...
                                                $start = ($page - 1) * $limit;
                                                $result = $conn->query("SELECT * FROM articles ORDER BY articles_id DESC LIMIT $start, $limit");
                                                $bulletin = $result->fetchAll();

                                                $result1 = $conn->query("SELECT count(articles_id) AS id FROM articles");
                                            ...
                                            ?>
                                                ...
                                                <?php include_once 'articlecontent.php'; ?>
                                            </div>
                                            <!-- End of the the main content that is associated with the index page -->
                                        </div>
                                    </div>
                                    <script src="http://maps.google.com/maps/api/js?sensor=true"></script>
                                    <div class="modal fade bd-example-modal-lg mt-5" id="removeArticleModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-backdrop="false">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" id="" name="" value="" class="mr-5 btn-transition btn btn-outline-danger finalDelete" data-dismiss="modal">
                                                Yes, Proceed
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <script>
                        ...
                        function edit(name, value, details, id)
                        {
                            $("#articleTitle").val(name);
                            $("#articleAuthor").val(value);
                            $("#articleDetails").val(details);
                            $('#edit').attr("value", "edit");
                            $('#postArticleNow').attr("value", id);

                            var forala = new FroalaEditor('#articleDetails');
