        ...
        ?>
            ...
            <!doctype html>
                ...
                <body>
                                    ...
                                    <div class="app-main__outer">
                                        <div class="app-main__inner">
                                            ...
                                            <?php 
                                                ...
                                                $start = ($page - 1) * $limit;
                                                $result = $conn->query("SELECT id, title, link FROM message WHERE type = 'video' && month = '$month' && year = '$year' ORDER BY id DESC LIMIT $start, $limit");
                                                $videos = $result->fetchAll();

                                                $result1 = $conn->query("SELECT count(id) AS id FROM message WHERE type = 'video' && month = '$month' && year = '$year'");
                                                ...
                                                <?php include_once 'videocontent.php'; ?>
                                            </div>
                                                
                                            <div class="modal fade bd-example-modal-lg mt-5" id="liveVideo" role="dialog" aria-labelledby="myLargeModalLabel" data-backdrop="false">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header text-primary">
                                                            <h5 class="modal-title">
                                                                Add Links for Live Program
                                                            </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    <label for="radio"><i class="pe-7s-radio"></i> Online Radio</label>
                                                                    <input type="text" class="form-control" name="radio" id="radio" required>
                                                                </div>
                                                            </div>
                                                            <button type="submit" name="live_links" value="live_links" class="btn btn-primary btm-sm btn-block">Add</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="modal fade mt-5" id="removeVideoModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-backdrop="false">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                <div class="position-relative">
                                    <p>
                                        <h6 class="text-center">You are about to remove the link to this video</h6>
                                    </p>
                                </div>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="" onclick="removeVideo(this.id)" class="mr-5 btn-transition btn btn-outline-danger finalDelete" data-dismiss="modal">
                                    Yes, Proceed
                                </button>
                            </div>
                        </div>
