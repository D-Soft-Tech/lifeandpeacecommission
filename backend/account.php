                    ...
                    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
                        ...
                        <!-- Main Content Starts from Here -->
                            <div class="app-main">
                                    ...
                                    <div class="app-main__outer">
                                        <div class="app-main__inner">
                                            ...
                                            <?php 
                                                ...
                                                $start = ($page - 1) * $limit;
                                                $result = $conn->query("SELECT * FROM account ORDER BY id DESC LIMIT $start, $limit");
                                                $account = $result->fetchAll();

                                                $result1 = $conn->query("SELECT count(id) AS id FROM account");
                                            ...
                                            ?>
                                                ...
                                                <?php include_once 'accountContent.php'; ?>
                                            </div>
                                    ...
                                    <div class="modal fade bd-example-modal-lg mt-5" id="removeAccountModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-backdrop="false">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                <div class="position-relative">
                                                    <p>
                                                        <h6 class="text-center">You are about to remove this account from the database</h6>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" id="" onclick="deleteAccount(this.id)" class="mr-5 btn-transition btn btn-outline-danger finalAccountDelete" data-dismiss="modal">
                                                    Yes, Proceed
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <script>
                        ...
                        $(document).ready(function (){
                            ...
                            $('.deleteAccount').click(function (){
                                ...
                                var deleteButton = $('.finalAccountDelete').attr("id", name);
                        ...
                        // $('.deleteArticle').click(function saveEdit(id, name, value, details)); 

                        function edit(id, name, value, purpose, bank_name)
                        {
                            $("#edit_title").val(name);
                            $("#edit_account_number").val(value);
                            $("#edit_account_purpose").val(purpose);
