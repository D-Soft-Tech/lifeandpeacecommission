        ...
        ?>
            ...
            <!doctype html>
                ...
                <head>
                    ...
                    <link rel="stylesheet" href="../assets/jqueryUI/jquery-ui.structure.css">
                    <link rel="stylesheet" href="../assets/jqueryUI/jquery-ui.theme.css">
                ...
                <body>
                    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
                        ...
                        <!-- Main Content Starts from Here -->
                            <div class="app-main">
                                    ...
                                    <div class="app-main__outer">
                                        <div class="app-main__inner">
                                            ...
                                            <?php 
                                                ...
                                                $start = ($page - 1) * $limit;
                                                $result = $conn->query("SELECT * FROM weekly_meeting ORDER BY meeting_id DESC LIMIT $start, $limit");
                                                $events = $result->fetchAll();

                                                $result1 = $conn->query("SELECT count(meeting_id) AS id FROM weekly_meeting");
                                            ...
                                            ?>
                                                ...
                                                <?php
                                                    include_once 'weeklyProgramContent.php'; 
                                                ?>
                                            </div>
                                    ...
                                    <div class="modal fade bd-example-modal-lg mt-5" id="removeEventModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-backdrop="false">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                <div class="position-relative">
                                                    <p>
                                                        <h6 class="text-center">You are about to Delete the event from the database</h6>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" id="" name="" value="" onclick="removeEvent(this.id, this.name, this.value)" class="mr-5 btn-transition btn btn-outline-danger finalDelete" data-dismiss="modal">
                                                    Yes, Proceed
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <script>
                        ...
                        function removeEvent(id, name, value){
                            XmlHttp
                            (
                                {
                                    url: 'testing.php',
                                    type: 'POST',
                                    data: "removeWeeklyProgram="+id+"&name="+name+"&value="+value,
