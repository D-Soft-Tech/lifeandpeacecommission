                                    ...
                                    <div class="app-main__outer">
                                        <div class="app-main__inner">
                                            ...
                                            <?php 
                                                ...
                                                $result1 = $conn->query("SELECT count(comment_id) AS comment_id FROM comments WHERE comments.obj = 'articles' && comments.status = 'pending'");
                                                $custCount = $result1->fetchAll();
                                                $total = $custCount[0]['comment_id'];
                                            ...
                                            ?>
                                                ...
                                                <?php include_once 'bulletincontent.php'; ?>
                                            </div>
